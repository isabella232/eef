	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ViewsPackage.VIEWS_REPOSITORY: {
				...
				if (result == null) result = caseDocumentedElement(viewsRepository);
				if (result == null) result = caseIdentifiedElement(viewsRepository);
			...
			case ViewsPackage.VIEW: {
				...
				if (result == null) result = caseContainer(view);
				if (result == null) result = caseViewElement(view);
				if (result == null) result = caseIdentifiedElement(view);
				if (result == null) result = caseDocumentedElement(view);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewsPackage.ELEMENT_EDITOR: {
				...
				if (result == null) result = caseViewElement(elementEditor);
				if (result == null) result = caseIdentifiedElement(elementEditor);
				if (result == null) result = caseDocumentedElement(elementEditor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ViewsPackage.CONTAINER: {
				...
				if (result == null) result = caseViewElement(container);
				if (result == null) result = caseIdentifiedElement(container);
				if (result == null) result = caseDocumentedElement(container);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewsPackage.VIEW_ELEMENT: {
				...
				if (result == null) result = caseDocumentedElement(viewElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewsPackage.CUSTOM_ELEMENT_EDITOR: {
				...
				if (result == null) result = caseElementEditor(customElementEditor);
				if (result == null) result = caseViewElement(customElementEditor);
				if (result == null) result = caseIdentifiedElement(customElementEditor);
				if (result == null) result = caseDocumentedElement(customElementEditor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewsPackage.CUSTOM_VIEW: {
				...
				if (result == null) result = caseContainer(customView);
				if (result == null) result = caseViewElement(customView);
				if (result == null) result = caseIdentifiedElement(customView);
				if (result == null) result = caseDocumentedElement(customView);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ViewsPackage.VIEW_REFERENCE: {
				...
				if (result == null) result = caseViewElement(viewReference);
				if (result == null) result = caseIdentifiedElement(viewReference);
				if (result == null) result = caseDocumentedElement(viewReference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
