 ...
 *
 */
public class ConferenceCustomItemProvider extends ConferenceItemProvider implements ITableItemLabelProvider {

	/**
	 * @param adapterFactory
	 */
	public ConferenceCustomItemProvider(AdapterFactory adapterFactory) {
