 ...
 *
 */
public class ScheduleCustomItemProvider extends ScheduleItemProvider implements ITableItemLabelProvider {

	/**
	 * @param adapterFactory
	 */
	public ScheduleCustomItemProvider(AdapterFactory adapterFactory) {
