 ...
 *
 */
public class VenueCustomItemProvider extends VenueItemProvider implements ITableItemLabelProvider {

	/**
	 * @param adapterFactory
	 */
	public VenueCustomItemProvider(AdapterFactory adapterFactory) {
