 ...
 *
 */
public class RoomCustomItemProvider extends RoomItemProvider implements ITableItemLabelProvider {

	/**
	 * @param adapterFactory
	 */
	public RoomCustomItemProvider(AdapterFactory adapterFactory) {
