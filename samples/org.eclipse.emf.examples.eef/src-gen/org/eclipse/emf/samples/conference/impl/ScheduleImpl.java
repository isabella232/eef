 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.samples.conference.impl.ScheduleImpl#getSessions <em>Sessions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScheduleImpl extends EObjectImpl implements Schedule {
	 ...
	 * @ordered
	 */
	protected EList<SessionSchedule> sessions;
	...
	protected EClass eStaticClass() {
		return ConferencePackage.Literals.SCHEDULE;
	}
	 ...
	 * @generated
	 */
	public EList<SessionSchedule> getSessions() {
		if (sessions == null) {
			sessions = new EObjectContainmentEList<SessionSchedule>(SessionSchedule.class, this, ConferencePackage.SCHEDULE__SESSIONS);
		}
		return sessions;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ConferencePackage.SCHEDULE__SESSIONS:
				getSessions().clear();
				getSessions().addAll((Collection<? extends SessionSchedule>)newValue);
				return;
		}
