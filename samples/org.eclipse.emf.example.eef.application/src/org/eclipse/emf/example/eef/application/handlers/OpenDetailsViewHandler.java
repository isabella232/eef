...
public class OpenDetailsViewHandler extends AbstractEEFOpenViewHandler {
	 ...
	 * @param inputObject
	 */
	public OpenDetailsViewHandler(EObject inputObject) {
	...
	protected EditingInput getEditingInput(IEclipseContext context, MPart mPart, Shell shell) {
		...
		if (editingInput instanceof URIEditingInput) {
			...
			PropertiesEditingContext editingContext = contextFactory.createPropertiesEditingContext((AdapterFactoryEditingDomain)editingDomain, ((Conference) inputObject).getSchedule());
