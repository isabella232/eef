...
public class SaveHandler {
	...
	@Execute
	public void execute(IEclipseContext context, final EPartService partService, @Named(IServiceConstants.ACTIVE_SHELL) Shell shell,@Named(IServiceConstants.ACTIVE_PART) final MContribution contribution)
