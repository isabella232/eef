...
* editExpression: The edit expression will be executed when the user will click in the checkbox widget. The current value of the checkbox will be accessible in a variable named @newValue@. This expression does not have to return anything.
