...
import org.eclipse.emf.eef.runtime.ui.swt.internal.view.propertyeditors.impl.emfpropertiestoolkit.edatepicker.EDatePickerPropertyEditor;
...
public class EDatePickerPlatformAwarePropertyEditorFactory extends EDatePickerPropertyEditorFactory {
	...
	public boolean serviceFor(PropertyEditorContext editorContext) {
		return EDatePickerPropertyEditorFactory.class.getName().equals(editorContext.viewElement.getRepresentation().getImplementation()) && editorContext.view.getContents() instanceof Composite;
	}
	...
	protected PropertyEditor createPropertyEditor(PropertyEditorContext editorContext) {
		...
		if (formtoolkit != null) {
			return new EDatePickerPropertyEditor(toolkit.getEEFEditingServiceProvider(), (PropertiesEditingView<Composite>) editorContext.view, (ElementEditor) editorContext.viewElement, new EDatePickerFormPropertyEditor(toolkit.getEditUIProvidersFactory(), toolkit.getImageManager(),
	...
	public Widget getModel(Resource resource) {
		...
		while (allContents.hasNext()) {
			...
			if (next instanceof Widget) {
				if (EDatePickerPropertyEditorFactory.class.getName().equals(((Widget) next).getImplementation())) {
					return (Widget) next;
				}
 			}
		}
