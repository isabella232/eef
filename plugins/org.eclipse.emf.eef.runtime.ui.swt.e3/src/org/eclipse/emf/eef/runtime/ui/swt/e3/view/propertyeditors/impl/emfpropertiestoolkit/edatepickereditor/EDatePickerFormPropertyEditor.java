...
public class EDatePickerFormPropertyEditor extends StandardFormPropertyEditor<SingleLinePropertyViewer> {
	 ...
	 * @param elementEditor
	 */
	public EDatePickerFormPropertyEditor(EditUIProvidersFactory editUIProvidersFactory, ImageManager imageManager, PropertiesEditingView<Composite> view, ElementEditor elementEditor) {
