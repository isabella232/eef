...
public abstract class AbstractEEFOpenViewHandler {
	...
	@Execute
	public void execute(IEclipseContext context, EModelService modelService, EPartService partService, EEFServiceRegistry serviceRegistry, MApplication applicationModel, Stage mainWindow) throws InvocationTargetException, InterruptedException {
		...
		EditingInput editingInput = getEditingInput(context, mPart, mainWindow);
	 ...
	 * @return 
	 */
	protected abstract EditingInput getEditingInput(IEclipseContext context, MPart mPart, Stage stage);
