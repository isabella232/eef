 ...
 * 
 */
package org.eclipse.emf.eef.runtime.ui.fx.e4.model.utils;
...
public class ApplicationModelBuilder {
	...
	protected void configurePartDescriptor(String partDescriptorID, MPartDescriptor eefPartDescriptor) {
		if (EEF_PART_DESCRIPTOR.equals(partDescriptorID)) {
			...
			eefPartDescriptor.setContributionURI("bundleclass://org.eclipse.emf.eef.runtime.ui.fx.e4/org.eclipse.emf.eef.runtime.ui.fx.e4.parts.E4EEFPart");
		}
	}
