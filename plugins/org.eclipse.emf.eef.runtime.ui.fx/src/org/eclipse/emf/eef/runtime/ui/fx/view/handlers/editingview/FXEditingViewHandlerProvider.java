 ...
 *
 */
public class FXEditingViewHandlerProvider extends AbstractEEFService<Object> implements ViewHandlerProvider {
	...
	public ViewHandler<?> getHandler(PropertiesEditingComponent editingComponent, Object view) {
		return new FXEditingViewHandler(this, editingComponent, (View) view);
	}
