 ...
 * 
 */
package org.eclipse.emf.eef.runtime.ui.fx.view.handlers.editingview;
...
import org.eclipse.emf.eef.runtime.ui.fx.internal.view.impl.FXImplPropertiesEditingView;
 ...
 *
 */
public class FXEditingViewHandler implements ViewHandler<PropertiesEditingView<Pane>> {

	protected View viewDescriptor;
	protected FXEditingViewHandlerProvider handlerProvider;
	 ...
	 */
	public FXEditingViewHandler(FXEditingViewHandlerProvider handlerProvider, PropertiesEditingComponent editingComponent, View viewDescriptor) {
	 ...
	 */
	public PropertiesEditingView<Pane> createView(Object... args) throws ViewConstructionException {
		if (view == null) {
			if (args.length > 1 && args[0] instanceof PropertiesEditingComponent && args[1] instanceof Pane) {
				PropertiesEditingComponent editingComponent = (PropertiesEditingComponent) args[0];
				view = new FXImplPropertiesEditingView(editingComponent, viewDescriptor);					
				view.setServiceRegistry(handlerProvider.getServiceRegistry());
				((FXPropertiesEditingView) view).createContents((Pane)args[1]);
			}
		}
		return view;
	}
	 ...
	 */
	public PropertiesEditingView<Pane> getView() { 
		return view;
	}
	 ...
	 */
	public void setView(PropertiesEditingView<Pane> propertiesEditingView) {
	...
	public void setValue(final Object field, final Object value) throws ViewHandlingException {
		if (view != null && view.getViewService() instanceof FXViewService) {
			((FXViewService) view.getViewService()).executeSyncUIRunnable(new Runnable() {
				public void run() {
