...
public class TextPropertyEditorProvider implements FXWidgetPropertyEditorProvider<Pane> {
	...
	public PropertyEditor getPropertyEditor(PropertyEditorContext<Pane> editorContext) {
		return new TextPropertyEditor(editorContext.view, (ElementEditor) editorContext.viewElement, new TextFXPropertyEditor(editorContext.view, (ElementEditor) editorContext.viewElement));
	}
