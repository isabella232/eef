		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ViewElement_representation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ViewElement_representation_feature", "_UI_ViewElement_type"),
				 ViewsPackage.Literals.VIEW_ELEMENT__REPRESENTATION,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ViewsPackage.Literals.VIEW_ELEMENT__NAME,
				 true,
				 false,
				 false,
