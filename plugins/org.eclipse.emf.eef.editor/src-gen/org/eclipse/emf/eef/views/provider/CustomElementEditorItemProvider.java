...
public class CustomElementEditorItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CustomElementEditor"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_CustomElementEditor_type") :
			getString("_UI_CustomElementEditor_type") + " " + label;
	}
