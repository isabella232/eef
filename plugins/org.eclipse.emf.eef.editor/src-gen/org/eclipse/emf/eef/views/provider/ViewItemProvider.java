		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_View_explicit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_View_explicit_feature", "_UI_View_type"),
				 ViewsPackage.Literals.VIEW__EXPLICIT,
				 true,
				 false,
				 false,
