...
public class ViewReferenceItemProvider
	...
	protected void addViewPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ViewReference_view_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ViewReference_view_feature", "_UI_ViewReference_type"),
				 ViewsPackage.Literals.VIEW_REFERENCE__VIEW,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ViewReference"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ViewReference_type") :
			getString("_UI_ViewReference_type") + " " + label;
	}
