		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_View_handler_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_View_handler_feature", "_UI_View_type"),
				 EditingModelPackage.Literals.VIEW__HANDLER,
				 true,
				 false,
				 false,
