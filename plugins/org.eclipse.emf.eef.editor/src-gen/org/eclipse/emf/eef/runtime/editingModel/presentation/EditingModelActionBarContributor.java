...
/**
 * This is the action bar contributor for the EditingModel model editor. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class EditingModelActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	/**
	 ...
	 * @generated
	 */
	protected IAction showPropertiesViewAction = new Action(EditingModelEditPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	 ...
	 * @generated
	 */
	protected IAction refreshViewerAction = new Action(EditingModelEditPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	 ...
	 * @generated
	 */
	public EditingModelActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("editingmodel-settings"));
		toolBarManager.add(new Separator("editingmodel-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(EditingModelEditPlugin.INSTANCE.getString("_UI_EditingModelEditor_menu"), "org.eclipse.emf.eef.runtime.editingModelMenuID");
		...
		//
		createChildMenuManager = new MenuManager(EditingModelEditPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(EditingModelEditPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(EditingModelEditPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(EditingModelEditPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
