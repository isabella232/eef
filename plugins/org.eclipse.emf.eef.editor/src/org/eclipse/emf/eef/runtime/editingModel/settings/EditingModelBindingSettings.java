 ...
 *
 */
public class EditingModelBindingSettings extends EEFBindingSettingsImpl {
	...
	protected String getEditingModelPath() {
		return "platform:/plugin/org.eclipse.emf.eef.editor/models/editingModel.editingmodel";
	}
