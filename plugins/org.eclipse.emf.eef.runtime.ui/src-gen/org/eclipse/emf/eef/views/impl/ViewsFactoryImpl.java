...
public class ViewsFactoryImpl extends EFactoryImpl implements ViewsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ViewsPackage.VIEWS_REPOSITORY: return createViewsRepository();
			case ViewsPackage.VIEW: return createView();
			case ViewsPackage.ELEMENT_EDITOR: return createElementEditor();
			case ViewsPackage.CATEGORY: return createCategory();
			case ViewsPackage.CONTAINER: return createContainer();
			case ViewsPackage.CUSTOM_ELEMENT_EDITOR: return createCustomElementEditor();
			case ViewsPackage.CUSTOM_VIEW: return createCustomView();
			case ViewsPackage.VIEW_REFERENCE: return createViewReference();
			default:
