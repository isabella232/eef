...
public abstract class PropertyEditorImpl implements PropertyEditor {
	...
	private ModelPropertyEditorProvider<? extends EObject, ?> propertyEditorProvider;
	
	/**
	 * @param propertyEditorProvider the propertyEditorProvider to set
	 */
	public void setPropertyEditorProvider(ModelPropertyEditorProvider<? extends EObject, ?> propertyEditorProvider) {
