 ...
 * 
 */
package org.eclipse.emf.eef.runtime.ui.swt.widgets;
...
import org.eclipse.emf.eef.runtime.ui.swt.internal.widgets.util.NullContentProvider;
...
public class MultiLinePropertyViewer extends StructuredViewer {
	...
	public void createContents() {
		...
		if (imageManager != null) {
			removeButton.setImage(imageManager.getImage(EEFRuntimeUISWT.getResourceLocator(), "Delete"));
		} else {
		...
		removeButton.addSelectionListener(new MultiLinePropertyViewerSelectionAdapter() {
			...
			/**
			 * {@inheritDoc}
			 * @see org.eclipse.emf.eef.runtime.ui.swt.widgets.MultiLinePropertyViewer.MultiLinePropertyViewerSelectionAdapter#fireSingleSelection(java.lang.Object)
			 */
			...
			/**
			 * {@inheritDoc}
			 * @see org.eclipse.emf.eef.runtime.ui.swt.widgets.MultiLinePropertyViewer.MultiLinePropertyViewerSelectionAdapter#fireMultiSelection(java.util.List)
			 */
		...
		if (imageManager != null) {
			upButton.setImage(imageManager.getImage(EEFRuntimeUISWT.getResourceLocator(), "ArrowUp"));
		} else {
			upButton.setText("up");
		}
