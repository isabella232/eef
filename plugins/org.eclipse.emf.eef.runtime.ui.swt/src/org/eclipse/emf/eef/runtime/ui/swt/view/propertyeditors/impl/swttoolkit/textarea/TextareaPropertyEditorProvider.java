...
public class TextareaPropertyEditorProvider extends WidgetPropertyEditorProviderImpl<Composite> {
	...
	protected PropertyEditor createPropertyEditor(PropertyEditorContext<Composite> editorContext) {
		return new TextareaPropertyEditor(editorContext.view, (ElementEditor) editorContext.viewElement, new TextareaSWTPropertyEditor(editorContext.view, (ElementEditor) editorContext.viewElement));
	}
