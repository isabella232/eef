...
public class TextPropertyEditorFactory extends WidgetPropertyEditorFactoryImpl<Composite> {
	 ...
	 * @param toolkit
	 */
	public TextPropertyEditorFactory(SWTToolkit toolkit) {
	...
	protected PropertyEditor createPropertyEditor(PropertyEditorContext editorContext) {
		return new TextPropertyEditor(toolkit.getEEFEditingServiceProvider(), (PropertiesEditingView<Composite>) editorContext.view, (ElementEditor) editorContext.viewElement, new TextSWTPropertyEditor((PropertiesEditingView<Composite>) editorContext.view, (ElementEditor) editorContext.viewElement));
	}
