 ...
 */
package org.eclipse.emf.eef.runtime.commands;
 ...
 * @since 2.2.0
 */
abstract public class EEFChangeCommand extends AbstractCommand {
	...
	protected EEFChangeCommand(ChangeRecorder changeRecorder) {
		this.changeRecorder = changeRecorder;
	}

	public EEFChangeCommand(ChangeRecorder changeRecorder, Notifier notifier) {
		this(changeRecorder);
		this.notifier = notifier;
	}

	public EEFChangeCommand(Notifier notifier) {
		this.notifier = notifier;
	}

	public EEFChangeCommand(ChangeRecorder changeRecorder, Collection<Notifier> notifiers) {
		this(changeRecorder);
		this.notifiers = notifiers;
	}

	public EEFChangeCommand(Collection<Notifier> notifiers) {
		this.notifiers = notifiers;
	}
	...
	/**
	 * Returns the {@link ChangeRecorder} specified in the constructor if any.
	 * 
	...
	/**
	 * Subclasses should override this to perform modifications to resources and
	 * objects. If no modification occurs, an
	 * {@link org.eclipse.emf.common.command.AbortExecutionException} may be
	 * thrown to avoid placing the command on the command stack.
	 */
	abstract protected void doExecute();

	/**
	 * Disposes the {@link ChangeRecorder} created by {@link #execute()}. The
	 * default implementation doesn't dispose the change recorder if it was
	 * passed in through one of the constructor methods.
	 * 
