...
public class ValidationBasedNotification implements EEFNotification {
	 ...
	 *            the {@link Diagnostic} causing this notification.
	 */
	...
	/**
	 * The tips here is the mapping between the {@link EEFNotification#ERROR},
	 * {@link EEFNotification#WARNING} fields and the {@link Diagnostic#ERROR},
	...
	public final String getMessage() {
		if (sourceDiagnostic instanceof BasicDiagnostic) {
			StringBuilder sb = new StringBuilder();
			for (Diagnostic diganostic : sourceDiagnostic.getChildren()) {
				sb.append(diganostic.getMessage()).append("\n");
			}
			return sb.toString();
		}
