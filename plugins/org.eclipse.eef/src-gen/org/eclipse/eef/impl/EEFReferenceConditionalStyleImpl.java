...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>EEF Reference Conditional Style</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.eef.impl.EEFReferenceConditionalStyleImpl#getStyle <em>Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EEFReferenceConditionalStyleImpl extends EEFConditionalStyleImpl implements EEFReferenceConditionalStyle {
	 ...
	 * @generated
	 */
	protected EEFReferenceConditionalStyleImpl() {
		super();
	}
		...
		if (style != null && style.eIsProxy()) {
			...
			if (style != oldStyle) {
				...
				NotificationChain msgs = oldStyle.eInverseRemove(this, InternalEObject.EOPPOSITE_FEATURE_BASE
						- EefPackage.EEF_REFERENCE_CONDITIONAL_STYLE__STYLE, null, null);
				if (newStyle.eInternalContainer() == null) {
					msgs = newStyle.eInverseAdd(this, InternalEObject.EOPPOSITE_FEATURE_BASE - EefPackage.EEF_REFERENCE_CONDITIONAL_STYLE__STYLE,
							null, msgs);
				}
				if (msgs != null) {
					msgs.dispatch();
				...
				if (eNotificationRequired()) {
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EefPackage.EEF_REFERENCE_CONDITIONAL_STYLE__STYLE, oldStyle, style));
				}
			}
		}
		return style;
	...
	public NotificationChain basicSetStyle(EEFReferenceStyle newStyle, NotificationChain msgs) {
		...
		style = newStyle;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EefPackage.EEF_REFERENCE_CONDITIONAL_STYLE__STYLE,
					oldStyle, newStyle);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newStyle != style) {
			...
			if (style != null) {
				msgs = ((InternalEObject) style).eInverseRemove(this, InternalEObject.EOPPOSITE_FEATURE_BASE
						- EefPackage.EEF_REFERENCE_CONDITIONAL_STYLE__STYLE, null, msgs);
			}
			if (newStyle != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_REFERENCE_CONDITIONAL_STYLE__STYLE, newStyle, newStyle));
		}
	}
